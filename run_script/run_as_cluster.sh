...
#java -Djava.net.preferIPv4Stack=true -Dvertx.zookeeper.config=classpath:config/zookeeper.json -jar simple-realtime-auctions-vertx4-example-1.0-fat.jar -cluster

...
#java -Dfile.encoding=UTF-8 -Dprofile=test -Dvertx.zookeeper.config=classpath:config/zookeeper-test.json -jar simple-realtime-auctions-vertx4-example-1.0-test-fat.jar -cluster
